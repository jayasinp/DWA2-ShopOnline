...
<!--register.php handles users request to register to shoponline-->
...
if ((isset($_POST["firstname"])) && (isset($_POST["surname"])) && (isset($_POST["email"])) && (isset($_POST["password"]))) {
    ...
    if ($emailValidated == false) {
        ...
        if ($emailValidated == false) {
            ...
            mail($to, $subject, $email_message, $header, "-f 104182850@student.swin.edu.au");
        }
    }
    echo $HTML;
}
...
function isEmailUnique($email)
{
    ...
    $xdoc->Load("../../data/customers.xml"); //Load your pre-existing customers.xml        
